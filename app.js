// База данных треков (бесплатные треки с открытых источников)
const tracks = [
    {
        id: 1,
        title: "Sunset Lover",
        ...
        color: "#667eea,#764ba2",
        icon: "fas fa-sun",
        audioUrl: "https://archive.org/download/petit-biscuit-sunset-lover/Petit%20Biscuit%20-%20Sunset%20Lover.mp3"
    },
    {
        id: 2,
        ...
        audioUrl: "https://archive.org/download/the-weeknd-blinding-lights/The%20Weeknd%20-%20Blinding%20Lights.mp3"
    },
    {
        id: 3,
        ...
        color: "#ff9a9e,#fad0c4",
        icon: "fas fa-crown",
        audioUrl: "https://archive.org/download/queen-bohemian-rhapsody/Queen%20-%20Bohemian%20Rhapsody.mp3"
    },
    {
        id: 4,
        title: "Shape of You",
        ...
        color: "#4facfe,#00f2fe",
        icon: "fas fa-heart",
        audioUrl: "https://archive.org/download/ed-sheeran-shape-of-you/Ed%20Sheeran%20-%20Shape%20of%20You.mp3"
    },
    {
        id: 5,
        title: "Billie Jean",
        ...
        color: "#43e97b,#38f9d7",
        icon: "fas fa-star",
        audioUrl: "https://archive.org/download/michael-jackson-billie-jean/Michael%20Jackson%20-%20Billie%20Jean.mp3"
    },
    {
        id: 6,
        ...
        color: "#a18cd1,#fbc2eb",
        icon: "fas fa-hotel",
        audioUrl: "https://archive.org/download/eagles-hotel-california/Eagles%20-%20Hotel%20California.mp3"
    },
    {
        id: 7,
        ...
        color: "#fdcbf1,#e6dee9",
        icon: "fas fa-stairs",
        audioUrl: "https://archive.org/download/led-zeppelin-stairway-to-heaven/Led%20Zeppelin%20-%20Stairway%20to%20Heaven.mp3"
    },
    {
        id: 8,
        title: "Clair de Lune",
        ...
        color: "#667eea,#764ba2",
        icon: "fas fa-moon",
        audioUrl: "https://archive.org/download/claude-debussy-clair-de-lune/Claude%20Debussy%20-%20Clair%20de%20Lune.mp3"
    },
    {
        id: 9,
        title: "Für Elise",
        ...
        color: "#4facfe,#00f2fe",
        icon: "fas fa-music",
        audioUrl: "https://archive.org/download/beethoven-fur-elise/Beethoven%20-%20F%C3%BCr%20Elise.mp3"
    },
    {
        id: 10,
        title: "Canon in D",
        ...
        color: "#43e97b,#38f9d7",
        icon: "fas fa-guitar",
        audioUrl: "https://archive.org/download/pachelbel-canon-in-d/Pachelbel%20-%20Canon%20in%20D.mp3"
    }
];
...
const radioStations = [
    {
        ...
        url: "https://icecast.thisisdistorted.com/thisischi.mp3",
        icon: "fas fa-wind"
    },
    {
        id: 2,
    ...
    },
    {
        ...
        url: "https://streamingv2.shoutcast.com/classical-radio",
        icon: "fas fa-music"
    },
    {
        id: 4,
...
class MusicPlayer {
    ...
    setupAudio() {
        // iOS требует user gesture для воспроизведения
    ...
    renderRadioStations() {
        ...
        const radioGrid = radioSection.querySelector('.radio-grid');
        if (!radioGrid) return;
        ...
        radioStations.forEach(station => {
            ...
            radioElement.className = `radio-card glass-effect ${this.isRadio && this.currentRadio?.id === station.id ? 'playing' : ''}`;
            radioElement.dataset.radio = station.genre;
            ...
            radioGrid.appendChild(radioElement);
        });
    }
    ...
    play() {
        this.audio.play().then(() => {
            ...
            alert('Нажмите на кнопку воспроизведения, чтобы начать прослушивание');
        });
    }
    ...
    nextTrack() {
        if (this.isRadio) return; // Для радио не переключаем треки
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => {
        ...
        console.log('Радиостанций:', radioStations.length);
    }, 1000);
});
